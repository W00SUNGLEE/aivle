...
select v.emp_id, e.emp_name, v.begin_date, v.duration, v.reason
	from vacation as v
...
-- 조인 #6 : 직원들의 휴가 현황
select emp_name, dept_id, hire_date, v.begin_date, v.duration, v.reason
	from employee as e
...
select emp_name, hire_date, dept_id, v.begin_date, v.reason
	from employee as e
    join vacation as v on v.emp_id = e.emp_id
